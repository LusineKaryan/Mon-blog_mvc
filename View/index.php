...
<main>
  <div class="container">
    ...
    <?php else: ?>
    <h1 class="page-title"style='font-family:Georgia'; >LA NATURE SAUVAGE</h1>
    <div class="row">
    <h5 class="subtitle">EXPOSITION PERSONNELLE DANS LA GALERIE DES ARTS</h5>
        ...
        <div class="col l6 m6 s12">
          <div class="card hoverable">
            ...
            <div class="card-content">
              ...
              <p><a href="<?=ROOT_URL?>blog_post_<?=$oPost->id?>.html">En savoir plus sur l'image </a></p>
            </div>
